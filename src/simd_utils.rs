...
/// Convert ASCII text to lowercase using SIMD
///
/// This function processes 32 bytes at a time using SIMD instructions,
...
mod tests {
    ...
    fn test_adaptive_lowercase_long() {
        ...
        let mut output = Vec::new();
        ascii_lowercase(text, &mut output);
        assert_eq!(&output, b"this is a long string that should trigger simd path for better performance");
    }
}
