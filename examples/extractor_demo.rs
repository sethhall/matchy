...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("   Input: \"2024-01-15 10:32:45 GET /api evil.example.com 192.168.1.1 - user@test.com\"");
    ...
    let log = b"[2024-10-16 23:45:00] INFO 192.168.1.100 user@company.com accessed api.prod.example.com";
