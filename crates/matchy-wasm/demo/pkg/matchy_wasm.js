...
const DatabaseBuilderFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_databasebuilder_free(ptr >>> 0, 1));

const ExtractorFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_extractor_free(ptr >>> 0, 1));

const ExtractorBuilderFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_extractorbuilder_free(ptr >>> 0, 1));
...
export class Database {
    ...
    lookupPattern(text) {
        ...
        const ret = wasm.database_lookupPattern(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
     ...
     */
    stats() {
        const ret = wasm.database_stats(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    lookup(key) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.database_lookup(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    lookupIp(ip) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.database_lookupIp(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
...
export class DatabaseBuilder {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        DatabaseBuilderFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_databasebuilder_free(ptr, 0);
    }
    /**
     ...
     * @param {any} data
     */
    addLiteral(literal, data) {
        const ptr0 = passStringToWasm0(literal, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.databasebuilder_addLiteral(this.__wbg_ptr, ptr0, len0, data);
        if (ret[1]) {
    ...
    addPattern(pattern, data) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.databasebuilder_addPattern(this.__wbg_ptr, ptr0, len0, data);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    ...
    constructor(case_sensitive) {
        const ret = wasm.databasebuilder_new(case_sensitive);
        this.__wbg_ptr = ret >>> 0;
        DatabaseBuilderFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
    ...
    build() {
        const ptr = this.__destroy_into_raw();
        const ret = wasm.databasebuilder_build(ptr);
        if (ret[3]) {
    ...
    addIp(ip, data) {
        const ptr0 = passStringToWasm0(ip, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.databasebuilder_addIp(this.__wbg_ptr, ptr0, len0, data);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    ...
    addEntry(key, data) {
        const ptr0 = passStringToWasm0(key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.databasebuilder_addEntry(this.__wbg_ptr, ptr0, len0, data);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
}
if (Symbol.dispose) DatabaseBuilder.prototype[Symbol.dispose] = DatabaseBuilder.prototype.free;
...
export class Extractor {
    static __wrap(ptr) {
        ...
        obj.__wbg_ptr = ptr;
        ExtractorFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        ExtractorFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_extractor_free(ptr, 0);
    }
    /**
    ...
    extract(text) {
        const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.extractor_extract(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
...
if (Symbol.dispose) Extractor.prototype[Symbol.dispose] = Extractor.prototype.free;
...
export class ExtractorBuilder {
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(ExtractorBuilder.prototype);
        obj.__wbg_ptr = ptr;
        ExtractorBuilderFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        ExtractorBuilderFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_extractorbuilder_free(ptr, 0);
    }
    /**
     * Enable or disable IPv4 extraction
     * @param {boolean} enable
     * @returns {ExtractorBuilder}
     */
    extractIpv4(enable) {
        const ptr = this.__destroy_into_raw();
        const ret = wasm.extractorbuilder_extractIpv4(ptr, enable);
        return ExtractorBuilder.__wrap(ret);
    }
    /**
    ...
    extractIpv6(enable) {
        const ptr = this.__destroy_into_raw();
        const ret = wasm.extractorbuilder_extractIpv6(ptr, enable);
        return ExtractorBuilder.__wrap(ret);
    }
    /**
     ...
     * @returns {ExtractorBuilder}
     */
    extractEmails(enable) {
        const ptr = this.__destroy_into_raw();
        const ret = wasm.extractorbuilder_extractEmails(ptr, enable);
        return ExtractorBuilder.__wrap(ret);
    }
    /**
     ...
     * @returns {ExtractorBuilder}
     */
    extractHashes(enable) {
        const ptr = this.__destroy_into_raw();
        const ret = wasm.extractorbuilder_extractHashes(ptr, enable);
        return ExtractorBuilder.__wrap(ret);
    }
    /**
     ...
     * @returns {ExtractorBuilder}
     */
    extractMonero(enable) {
        const ptr = this.__destroy_into_raw();
        const ret = wasm.extractorbuilder_extractMonero(ptr, enable);
        return ExtractorBuilder.__wrap(ret);
    }
    /**
     ...
     * @returns {ExtractorBuilder}
     */
    extractBitcoin(enable) {
        const ptr = this.__destroy_into_raw();
        const ret = wasm.extractorbuilder_extractBitcoin(ptr, enable);
        return ExtractorBuilder.__wrap(ret);
    }
    /**
     ...
     * @returns {ExtractorBuilder}
     */
    extractDomains(enable) {
        const ptr = this.__destroy_into_raw();
        const ret = wasm.extractorbuilder_extractDomains(ptr, enable);
        return ExtractorBuilder.__wrap(ret);
    }
    /**
     ...
     * @returns {ExtractorBuilder}
     */
    extractEthereum(enable) {
        const ptr = this.__destroy_into_raw();
        const ret = wasm.extractorbuilder_extractEthereum(ptr, enable);
        return ExtractorBuilder.__wrap(ret);
    }
    /**
    ...
    minDomainLabels(min) {
        const ptr = this.__destroy_into_raw();
        const ret = wasm.extractorbuilder_minDomainLabels(ptr, min);
        return ExtractorBuilder.__wrap(ret);
    }
    /**
     ...
     */
    constructor() {
        const ret = wasm.extractorbuilder_new();
        this.__wbg_ptr = ret >>> 0;
        ExtractorBuilderFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
    ...
    build() {
        const ptr = this.__destroy_into_raw();
        const ret = wasm.extractorbuilder_build(ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return Extractor.__wrap(ret[0]);
    }
}
if (Symbol.dispose) ExtractorBuilder.prototype[Symbol.dispose] = ExtractorBuilder.prototype.free;
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('matchy_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
